...
exports.default = {
    templateUrl: 'src/core/components/card-content/template.html',
    bindings: {
        title: '@',
        subtitle: '@',
        detail: '@',
...
exports.default = {
    templateUrl: 'src/core/components/card-header/template.html',
    bindings: {
        image: '@',
        title: '@',
        subtitle: '@'
...
exports.default = {
    templateUrl: 'src/core/components/card-media/template.html',
    bindings: {
        progress: '@',
        resource: '@'
    }
...
angular.module('app.core.components', []).component('jdsToolbar', _toolbar2.default).component('jdsDrawer', _drawer2.default).component('jdsMain', _main2.default).component('jdsJumbotron', _jumbotron2.default).component('jdsContainer', _container2.default).component('jdsCard', _card2.default).component('jdsCardHeader', _cardHeader2.default).component('jdsCardMedia', _cardMedia2.default).component('jdsCardContent', _cardContent2.default).component('jdsList', _list2.default).component('jdsListItem', _listItem2.default).component('jdsLoader', _loader2.default);
},{"./card":5,"./card-content":2,"./card-header":3,"./card-media":4,"./container":6,"./drawer":8,"./jumbotron":10,"./list":12,"./list-item":11,"./loader":14,"./main":15,"./toolbar":16}],10:[function(require,module,exports){
'use strict';
...
exports.default = {
    templateUrl: 'src/core/components/list-item/template.html',
    bindings: {
        url: '@',
        image: '@',
        title: '@',
...
exports.default = {
    transclude: true,
    templateUrl: 'src/core/components/list/template.html'
};
...
},{"./toggle-menu":19}],19:[function(require,module,exports){
'use strict';
...
},{"./components":9,"./constants":17,"./directives":18,"./services":22}],21:[function(require,module,exports){
'use strict';
...
},{"./contact":25,"./home":28,"./jobs":32,"./skills":35,"./study":38}],31:[function(require,module,exports){
'use strict';
...
},{"./controller":31,"./route":33}],33:[function(require,module,exports){
'use strict';
...
},{"./controller":34,"./route":36}],36:[function(require,module,exports){
'use strict';
...
},{"./controller":37,"./route":39}],39:[function(require,module,exports){
'use strict';
...
},{"./app/route":1,"./core/":20,"./features/":30}]},{},[40,23])
